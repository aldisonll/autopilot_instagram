...
print("Go to instagram and start copy links! Have fun!")
while True:
        ...
        if recent_value[0:28] == "https://www.instagram.com/p/": # check if copied value is a image from instagram
           ...
           try:
                ...
                with open("photos/" + str(recent_value[29:39]) + ".jpg", "wb") as f: # downloading image to /photos folder
                    ...
                    toaster.show_toast("Instagram AutoPilot 1.0", "Image Downloaded: " + str("https://www.instagram.com/" + recent_value[29:39]), icon_path="logo.ico",) # send the notification (windows user)
